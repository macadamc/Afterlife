...
namespace Cinemachine
{
    ...
    public class CinemachineImpulseListenerAtTarget : CinemachineExtension
    {
            ...
            CinemachineCore.Stage stage, ref CameraState state, float deltaTime)
        {
            if (stage == CinemachineCore.Stage.Aim)
            {
                ...
                if (CinemachineImpulseManager.Instance.GetImpulseAt(
                    targetTransform.position, m_Use2DDistance, m_ChannelMask, out impulsePos, out impulseRot))
                {
